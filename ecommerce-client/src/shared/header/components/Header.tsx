...
const RegisterModal: LazyExoticComponent<FC<IModalBgProps>> = lazy(() => import('~/features/auth/components/Register'));
const ForgotPasswodModal: LazyExoticComponent<FC<IModalBgProps>> = lazy(() => import('~features/auth/components/ForgotPassword'));
            ...
            <div className="flex flex-wrap items-center justify-between gap-6 md:gap-0 md:py-3 lg:py-5">
              <div className="flex w-full items-center justify-between lg:w-auto">
                ...
                <div className="peer-checked:hamburger relative z-20 -mr-6 block cursor-pointer p-6 lg:hidden">
                  <Button
                    className="m-auto rounded transition duration-300"
