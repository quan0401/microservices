...
import { ICertificate, ICertificateProps } from '~features/seller/interfaces/seller.interface';
            ...
            <div className="relative flex flex-col">
              ...
              {certificatesFields.length > 1 && index > 0 && (
                <div className="mb-4 mt-16">
                  <Button
                    className="md:text-md h-7 rounded flex items-center bg-red-500 px-6 text-center text-sm font-bold text-white hover:bg-red-400 focus:outline-none md:px-8"
