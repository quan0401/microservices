...
import { ISocialLinksProps } from '~features/seller/interfaces/seller.interface';
      ...
      <div className="flex w-full flex-col px-6 pb-3 pt-6">
        <div className="flex justify-between">
          ...
          <Button
            ...
            className="md:text-md h-7 rounded flex items-center bg-sky-500 px-6 text-center text-sm font-bold text-white hover:bg-sky-400 focus:outline-none md:px-8"
            label="Add More"
          />
        </div>
          ...
          <div key={index}>
            ...
            <div className="my-4">
              {socialFields.length > 1 && index > 0 && (
                <Button
                  className="md:text-md h-7 rounded flex items-center flex items-center bg-red-500 px-6 text-center text-sm font-bold text-white hover:bg-red-400 focus:outline-none md:px-8"
