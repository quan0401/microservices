...
import { rating, sellerOrderList } from '~shared/utils/utils.service';
import ActiveOrderTable from './ActiveOrdersTable';
import GigCardItem from '~shared/gigs/GigCardItem';
...
const DashboardMain: FC = (): ReactElement => {
  ...
  return (
    <div className="flex flex-wrap gap-x-4">
      <div className="order-firsts w-full py-4 md:w-1/3">
      ...
      <div className="w-full py-4 md:w-[65%]">
