...
import { useParams, useSearchParams, NavigateFunction, useNavigate } from 'react-router-dom';
...
import { deleteFromLocalStorage, generateRandomNumber, getDataFromLocalStorage, showErrorToast } from '~shared/utils/utils.service';
