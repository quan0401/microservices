...
import { IDeliveredWork, IOrderDeliveredModal, IOrderDeliveredProps, IOrderMessage } from '~features/order/interfaces/order.interface';
import { useApproveOrderMutation } from '~features/order/services/order.service';
...
import { bytesToSize, downloadFile, getFileBlob, showErrorToast, showSuccessToast } from '~shared/utils/utils.service';
              ...
              <div className="flex gap-4">
                ...
                <div className="border-grey w-full cursor-pointer border-b pb-5" ref={ref}>
                  <div className="mt-2 flex items-center justify-between font-medium text-gray-500">
                    ...
                    <div>{!orderDeliveredModal.delivery ? <FaChevronDown size={15} /> : <FaChevronUp size={15} />}</div>
                  </div>
