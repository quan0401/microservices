...
const OrderDetailsTable: FC<IOrderProps> = ({ order, authUser }): ReactElement => {
  ...
  return (
    <div className="flex rounded-[4px] bg-white px-4 py-3" onClick={() => setShowOrderDetailsPanel((item: boolean) => !item)}>
        ...
        <div className="flex gap-4">
          ...
          <div className="w-full cursor-pointer">
            <div className="mt-2 flex items-center justify-between font-medium text-gray-500">
              ...
              <div>{!showOrderDetailsPanel ? <FaChevronDown size={15} /> : <FaChevronUp size={15} />}</div>
            </div>
