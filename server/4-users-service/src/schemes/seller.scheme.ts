...
const sellerScheme: ObjectSchema = Joi.object().keys({
  ...
  profilePublicId: Joi.string().required().messages({
    'string.base': 'Please add a profilePublicId',
    'string.empty': 'ProfilePublicId is required',
    'any.required': 'ProfilePublicId is required'
  }),
