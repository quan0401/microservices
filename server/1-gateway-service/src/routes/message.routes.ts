...
class MessageRoutes {
  ...
  public routes(): Router {
    this.router.get('/message/conversation/:senderEmail/:receiverEmail', Get.prototype.conversation);
    this.router.get('/message/conversations/:email', Get.prototype.conversationList);
    this.router.get('/message/:senderEmail/:receiverEmail', Get.prototype.messages);
